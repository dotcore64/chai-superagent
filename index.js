  ...
  (chai, _) => {
    ...
    function checkContentType(name) {
      ...
      Assertion.addProperty(name, function () {
        ...
        const ins = i(ct) === "undefined" ? "headers" : i(ct);
    ...
    Assertion.addMethod("redirectTo", function (destination) {
      ...
      if (redirects?.length > 0) {
        const hasRedirected =
          Object.prototype.toString.call(destination) === "[object RegExp]"
    ...
    Assertion.addMethod("param", function (...args) {
      ...
      _.transferFlags(this, assertion);
      assertion._obj = qs.parse(
        new URL(this._obj.url, "https://dummy.com").search.replace(/^\?/, ""),
      );
    ...
    Assertion.addMethod("cookie", function (key, value) {
      ...
      const header =
        getHeader(this._obj, "set-cookie") ||
